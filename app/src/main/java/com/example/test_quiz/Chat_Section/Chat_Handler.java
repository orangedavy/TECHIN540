...
public class Chat_Handler extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        database1 = FirebaseDatabase.getInstance("https://dialysis-55e67-default-rtdb.firebaseio.com/").getReference();
        FirebaseDatabase database = FirebaseDatabase.getInstance("https://dialysis-55e67-default-rtdb.firebaseio.com/");
        reference = database.getReference("chat").child(auth.getUid());
        ...
        // final String user_id = "gs://dialysis-55e67.appspot.com/" + auth.getUid();
