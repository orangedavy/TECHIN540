...
//        if(convertView==null) {
            ...
            if (item.getUsername().equals("David")) {
                ...
                //Log.d(username, message);
                convertView = inflater.inflate(R.layout.list_chat_item_right, parent, false);
                // viewHolder.circleImageView = convertView.findViewById(R.id.userChatImage);
                viewHolder.username = convertView.findViewById(R.id.list_item_username_right);
                viewHolder.message = convertView.findViewById(R.id.list_item_message_right);
...
//            //Log.d(username, message);
//            //Log.d(viewHolder.username.getText().toString(), viewHolder.message.getText().toString());
//        }
